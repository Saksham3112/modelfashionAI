...
if __name__ == '__main__':
    ...
    for idx in tqdm(range(test_kpda.size())):
        ...
        hm_pred_flip2 = compute_keypoints(
            config, img0_flip, net2, encoder, doflip=True)
